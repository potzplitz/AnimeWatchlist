...
public class SearchAnime {
	...
	public void search() {
		...
		start.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(int i = 0; i < getApi.arrayLength(); i++) {
					...
					// Maps erstellen damit button und wert miteinander verkn�pft werden k�nnen
					...
					// map entrys erstellen, damit gedr�ckte buttonelemente einfacher ausgegeben werden k�nnen
					
					Map.Entry<String, JButton> picturelinkentry = linkmap.entrySet().iterator().next(); // entry f�r das bild des animes
					Map.Entry<String, JButton> malentry = malmap.entrySet().iterator().next(); // entry f�r den link der my anime list
					Map.Entry<String, JButton> buttonentry = buttonMap.entrySet().iterator().next(); // entry f�r die buttons
					
			
					
					// buttons ordnungsgem�� dem scrollpanel hinzuf�gen
					...
					button.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {	
							...
							buttonpress = buttonentry.getKey(); // sagt, was f�r ein button gedr�ckt wurde
		...
		JButton AddAnime = new JButton("Anime hinzuf�gen");
